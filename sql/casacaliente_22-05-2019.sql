...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2019 a las 21:44:11
...
INSERT INTO `dbtarifas` (`idtarifa`, `reftipoubicacion`, `tarifa`, `desdeperiode`, `finsaperiode`) VALUES
(1, 2, '365.00', '2019-01-12', '2019-01-26'),
(2, 4, '395.00', '2019-01-12', '2019-01-26'),
(3, 5, '425.00', '2019-01-12', '2019-01-26'),
(4, 6, '445.00', '2019-01-12', '2019-01-26'),
(5, 7, '425.00', '2019-01-12', '2019-01-26'),
(6, 8, '445.00', '2019-01-12', '2019-01-26'),
(7, 9, '445.00', '2019-01-12', '2019-01-26');
...
ALTER TABLE `dbtarifas`
 ADD PRIMARY KEY (`idtarifa`), ADD KEY `fk_tarifa_tipoubicacion_idx` (`reftipoubicacion`), ADD KEY `fk_tarifa_periodos_idx` (`desdeperiode`);
