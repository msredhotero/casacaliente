...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-02-2020 a las 13:37:03
...
--
-- Base de datos: `casacaliente_05122019`
--
...
`idcliente` int(11) NOT NULL,
  ...
  `reflocatarios` int(11) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4373 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dblloguercomentarios`
--

CREATE TABLE IF NOT EXISTS `dblloguercomentarios` (
`idlloguercomentario` int(11) NOT NULL,
...
`idlloguer` int(11) NOT NULL,
  ...
  `nrolloguer` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=3016 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dblloguersadicional`
--

CREATE TABLE IF NOT EXISTS `dblloguersadicional` (
`idllogueradicional` int(11) NOT NULL,
  `reflloguers` int(11) NOT NULL,
  `personas` int(11) NOT NULL,
  `entrada` date NOT NULL,
  `sortida` date NOT NULL,
  `taxapersona` decimal(10,2) NOT NULL,
  `taxaturistica` decimal(10,2) NOT NULL,
...
--
-- Estructura de tabla para la tabla `dblocatarios`
--

CREATE TABLE IF NOT EXISTS `dblocatarios` (
`idlocatario` int(11) NOT NULL,
  `razonsocial` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `nif` varchar(11) COLLATE utf8_spanish_ci DEFAULT NULL,
  `carrer` varchar(300) COLLATE utf8_spanish_ci DEFAULT NULL,
  `codipostal` varchar(14) COLLATE utf8_spanish_ci DEFAULT NULL,
  `ciutat` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL,
  `pais` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `dblocatarios`
--

INSERT INTO `dblocatarios` (`idlocatario`, `razonsocial`, `nif`, `carrer`, `codipostal`, `ciutat`, `pais`, `telefon`, `email`) VALUES
(3, 'Casa Caliente', '', '', '', 'Barcelona', 'EspaÃ±a', '', ''),
(4, 'WWW', '', '', '', '', '', '', '');
...
) ENGINE=InnoDB AUTO_INCREMENT=849 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `dbusuarios` (`idusuario`, `usuario`, `password`, `refroles`, `email`, `nombrecompleto`, `activo`, `reflocatarios`) VALUES
(1, 'Marcos', 'marcos', 1, 'msredhotero@msn.com', 'Marcos Saupurein', b'1', NULL),
(2, 'Andres', 'andres', 2, 'andres@casacaliente.es', 'andres', b'1', 3),
(3, 'javier', 'javier', 2, 'javier@www.es', 'Javier WWW', b'1', 4);
...
(13, '../index.php', 'dashboard', 'Dashboard', 1, NULL, 'Administrador, Empresas', b'1', b'1', b'0', 0),
(19, '../clientes/', 'people_outline', 'Clientes', 2, NULL, 'Administrador, Empresas', b'1', b'0', b'0', 0),
(20, '../usuarios/', 'account_circle', 'Usuarios', 12, NULL, 'Administrador', b'1', b'0', b'0', 0),
(21, '../tipoubicacion/', 'chevron_right', 'Tipo Ubicacion', 9, NULL, 'Administrador, Empresas', b'1', b'0', b'0', 3),
(23, '../tarifes/', 'chevron_right', 'Tarifes', 4, NULL, 'Administrador, Empresas', b'1', b'0', b'0', 3),
(24, '../ubicaciones/', 'chevron_right', 'Ubicaciones', 6, NULL, 'Administrador, Empresas', b'1', b'0', b'0', 3),
(25, '../periodes/', 'chevron_right', 'Periodes', 7, NULL, 'Administrador, Empresas', b'1', b'1', b'1', 3),
(26, '../lloguers/', 'date_range', 'Lloguers', 3, NULL, 'Administrador, Empresas', b'1', b'1', b'1', 0),
(27, '../llogater/', 'chevron_right', 'Empresas', 10, NULL, 'Administrador', b'1', b'1', b'1', 3),
(28, '../reportes/', 'print', 'Reportes', 5, NULL, 'Administrador, Empresas', b'1', b'1', b'1', 0);
...
(2, 'Confirmado', 'green', NULL, 2, 1, 1),
(3, 'Cancelado', 'red', NULL, 3, 1, 1),
(4, 'Cancelado-Previo', 'black', NULL, 4, 1, 1);
...
--
-- Volcado de datos para la tabla `tbformaspagos`
--

INSERT INTO `tbformaspagos` (`idformapago`, `formapago`, `abreviatura`) VALUES
(1, 'GIRO', 'GI'),
(2, 'BANC SABADELL', 'BS'),
(3, 'EFECTIU', 'EF');
...
--
-- Estructura de tabla para la tabla `tbtaxa`
--

CREATE TABLE IF NOT EXISTS `tbtaxa` (
`idtaxa` int(11) NOT NULL,
  `taxaper` decimal(10,2) NOT NULL,
  `taxaturistico` decimal(10,2) NOT NULL,
  `maxtaxa` decimal(10,2) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `tbtaxa`
--

INSERT INTO `tbtaxa` (`idtaxa`, `taxaper`, `taxaturistico`, `maxtaxa`) VALUES
(1, '20.00', '0.90', '6.30');
...
--
-- Indices de la tabla `dblloguercomentarios`
--
ALTER TABLE `dblloguercomentarios`
 ADD PRIMARY KEY (`idlloguercomentario`), ADD KEY `fk_lloguer_co_idx` (`reflloguers`);

--
-- Indices de la tabla `dblloguers`
--
ALTER TABLE `dblloguers`
 ADD PRIMARY KEY (`idlloguer`), ADD KEY `fk_llog_clie_idx` (`refclientes`), ADD KEY `fk_llog_ubi_idx` (`refubicaciones`), ADD KEY `fk_llog_est_idx` (`refestados`);

--
-- Indices de la tabla `dblloguersadicional`
--
ALTER TABLE `dblloguersadicional`
 ADD PRIMARY KEY (`idllogueradicional`), ADD KEY `fk_llo_ad_idx` (`reflloguers`);

--
-- Indices de la tabla `dblocatarios`
--
ALTER TABLE `dblocatarios`
...
ALTER TABLE `dbperiodos`
 ADD PRIMARY KEY (`idperiodo`), ADD KEY `fk_p_loc_idx` (`reflocatarios`);
...
ALTER TABLE `tbtipoubicacion`
 ADD PRIMARY KEY (`idtipoubicacion`), ADD KEY `fk_tu_loc_idx` (`reflocatarios`);
...
--
ALTER TABLE `dbclientes`
MODIFY `idcliente` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4373;
--
-- AUTO_INCREMENT de la tabla `dblloguercomentarios`
--
ALTER TABLE `dblloguercomentarios`
MODIFY `idlloguercomentario` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `dblloguers`
--
ALTER TABLE `dblloguers`
MODIFY `idlloguer` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3016;
--
-- AUTO_INCREMENT de la tabla `dblloguersadicional`
--
ALTER TABLE `dblloguersadicional`
MODIFY `idllogueradicional` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `dblocatarios`
--
ALTER TABLE `dblocatarios`
MODIFY `idlocatario` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `dbperiodos`
MODIFY `idperiodo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=131;
--
-- AUTO_INCREMENT de la tabla `dbtarifas`
--
ALTER TABLE `dbtarifas`
MODIFY `idtarifa` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=849;
--
...
--
-- AUTO_INCREMENT de la tabla `tbtaxa`
--
ALTER TABLE `tbtaxa`
MODIFY `idtaxa` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `tbtipoubicacion`
--
ALTER TABLE `tbtipoubicacion`
MODIFY `idtipoubicacion` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- Restricciones para tablas volcadas
--

--
-- Filtros para la tabla `dblloguercomentarios`
--
ALTER TABLE `dblloguercomentarios`
ADD CONSTRAINT `fk_lloguer_co` FOREIGN KEY (`reflloguers`) REFERENCES `dblloguers` (`idlloguer`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `dblloguers`
--
ALTER TABLE `dblloguers`
ADD CONSTRAINT `fk_llog_clie` FOREIGN KEY (`refclientes`) REFERENCES `dbclientes` (`idcliente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_llog_est` FOREIGN KEY (`refestados`) REFERENCES `tbestados` (`idestado`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_llog_ubi` FOREIGN KEY (`refubicaciones`) REFERENCES `dbubicaciones` (`idubicacion`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `dblloguersadicional`
--
ALTER TABLE `dblloguersadicional`
ADD CONSTRAINT `fk_llo_ad` FOREIGN KEY (`reflloguers`) REFERENCES `dblloguers` (`idlloguer`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `dbperiodos`
--
ALTER TABLE `dbperiodos`
ADD CONSTRAINT `fk_p_loc` FOREIGN KEY (`reflocatarios`) REFERENCES `dblocatarios` (`idlocatario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Filtros para la tabla `tbtipoubicacion`
--
ALTER TABLE `tbtipoubicacion`
ADD CONSTRAINT `fk_tu_loc` FOREIGN KEY (`reflocatarios`) REFERENCES `dblocatarios` (`idlocatario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
