...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-07-2019 a las 18:40:13
...
--
-- Volcado de datos para la tabla `dblloguers`
--

INSERT INTO `dblloguers` (`idlloguer`, `refclientes`, `refubicaciones`, `datalloguer`, `entrada`, `sortida`, `total`, `numpertax`, `persset`, `taxa`, `maxtaxa`, `refestados`) VALUES
(1, 1, 26, '2019-06-26', '2019-06-26 00:00:00', '2019-07-03 00:00:00', '857.60', 2, 2, '20.00', '0.90', 1),
(2, 1, 10, '2019-06-28', '2019-08-24 00:00:00', '2019-09-07 00:00:00', '1375.20', 2, 2, '20.00', '0.90', 1),
(3, 2, 10, '2019-06-28', '2019-08-24 00:00:00', '2019-09-07 00:00:00', '1375.20', 2, 2, '20.00', '0.90', 1),
(4, 1, 10, '2019-06-28', '2019-08-24 00:00:00', '2019-09-07 00:00:00', '1362.60', 2, 2, '20.00', '0.90', 1);
...
--
ALTER TABLE `dblloguers`
MODIFY `idlloguer` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `dbtarifas`
MODIFY `idtarifa` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=80;
--
