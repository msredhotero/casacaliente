...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../tipoubicacion/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Tipo Ubicacion",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Tipo Ubicacion";

$plural = "Tipo Ubicaciones";

$eliminar = "eliminarTipoubicacion";

$insertar = "insertarTipoubicacion";
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=tipoubicacion",
			"language": {
