							...
							<form class="form" id="formRpt">
								...
								<div class="row">
									<div class="form-group col-md-10">
										<label class="control-label" style="text-align:left" for="refcliente">Seleccione Empresa | Desde | Hasta</label>
					...
					<div class="card ">
						...
						<div class="body">
							<form class="form" id="formRpt">
								...
								<div class="row">
									<div class="form-group col-md-10">
										<label class="control-label" style="text-align:left" for="refcliente">Seleccione Empresa | Any</label>
										<div class="input-group col-md-12">
											<span class="input-group-addon">
							...
							<form class="form" id="formRpt">
								...
								<div class="row">
									<div class="form-group col-md-10">
										...
										<div class="input-group col-md-12">
											<span class="input-group-addon">
												<select class="form-control" id="reflocatarios4" name="reflocatarios4" required />
												<?php echo $cadRef; ?>
												</select>
											</span>
											<span class="input-group-addon">
												<select class="form-control show-tick" id="any4" name="any4" required />
									...
									<div class="form-group col-md-2">
										<ul class="list-inline">
											<li>
												<button type="button" class="btn btn-success" id="rptFaltaPagar" style="margin-left:0px;">Generar</button>
											</li>
										</ul>
...
<script>
	$(document).ready(function(){
		...
		$('#rptFaltaPagar').click(function() {
			if ($("#any2").val() != '') {
				window.open("../../reportes/rptFaltaPagar.php?idlocatario=" + $("#reflocatarios4").val() + "&any=" + $("#any4").val() ,'_blank');
			}
		...
		traerAnyPagos($('#reflocatarios4').val(), 'any4');
